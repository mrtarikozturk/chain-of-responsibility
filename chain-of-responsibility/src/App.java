...
public class App {
    ...
    public static void main(String[] args) {
        ...
        // The king makes requests and the military orcs form the handler chain.
        var king = new OrcKing();
        king.makeRequest(new Request(RequestType.DEFEND_CASTLE, "defend castle"));
        king.makeRequest(new Request(RequestType.TORTURE_PRISONER, "torture prisoner"));
        king.makeRequest(new Request(RequestType.COLLECT_TAX, "collect tax"));
        king.makeRequest(new Request(RequestType.DEFEND_CASTLE, "defend castle 2"));
        king.makeRequest(new Request(RequestType.COLLECT_TAX, "collect tax 2"));
    }
}